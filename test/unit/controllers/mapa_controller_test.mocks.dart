...
// in alertacan/test/unit/controllers/mapa_controller_test.dart.
...
import 'package:alertacan/services/ubicacion_service.dart' as _i9;
...
class _FakePosition_12 extends _i1.SmartFake implements _i6.Position {
  _FakePosition_12(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
///
/// See the documentation for Mockito's code generation for more information.
class MockUbicacionService extends _i1.Mock implements _i9.UbicacionService {
  @override
  _i5.Future<_i6.Position> obtenerUbicacionActual() =>
      (super.noSuchMethod(
            ...
            returnValueForMissingStub: _i5.Future<_i6.Position>.value(
              _FakePosition_12(
                this,
                Invocation.method(#obtenerUbicacionActual, []),
              ),
  ...
  @override
  String obtenerTextoUbicacion(_i6.Position? posicion) =>
      (super.noSuchMethod(
